...
@patch("rootsight.backend.rca_module.generate")
@patch("rootsight.backend.impact_module.generate")
@patch("rootsight.backend.memory_module.generate")
@patch("rootsight.backend.memory_module.vector_store.search_similar")
