...
from rootsight.backend.ingestion_service import RawEvent
from rootsight.backend.timeline_module import build_timeline
from rootsight.backend.schemas.event import EventType
...
@pytest.mark.asyncio
@patch("rootsight.backend.timeline_module.generate")
