...
class IncidentOutcomeUpdate(SQLModel):
    correct_hypothesis_id: Optional[str] = Field(default=None, max_length=64)
    resolution_notes: str = Field(min_length=1, max_length=4000)
    mttr_minutes: Optional[int] = Field(default=None, ge=0)
